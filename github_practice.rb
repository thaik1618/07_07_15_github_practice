...
# Run the file by typing "ruby github_practice.rb" in your command line.
...
#  WOO!    IMPRESSIVE!
#  WOO!    Do you want more? See if you can follow these instructions for git on your own.
...
# STEP  9: Type "git commit -m "my first commit" and hit enter (This will add a note and a save to git)
